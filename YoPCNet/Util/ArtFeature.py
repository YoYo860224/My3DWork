...
if __name__ == "__main__":
    ...
    pcd_path = os.path.join(dataRoot, "N")
    img_path = os.path.join(dataRoot, "N_img")
    saveFeature = os.path.join(dataRoot, "N_feature.npy")
    ...
    featureLen = f.shape[1]

    features = np.ndarray((0, featureLen), dtype=np.float32)
    print("Feature size is: ", featureLen)
